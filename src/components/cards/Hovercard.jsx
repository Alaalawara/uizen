  ...
  return (
    <div className="flex flex-col gap-10">
      <div className="flex flex-col gap-4 items-start">
        ...
        <h1 className="bg-red-800 px-2 py-2 rounded-lg">fix x axis scrolling issues</h1>
      </div>
      ...
      <div className="flex flex-col gap-4">
        ...
        {tab === 'preview' ? (
          ...
          <div className="rounded-lg overflow-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] border h-[400px] min-h-[400px] max-h-[400px] border-foreground max-w-[800px] w-[800px] bg-secondary">
